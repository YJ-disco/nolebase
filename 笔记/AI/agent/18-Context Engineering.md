...
**这六类里「工具定义」那一项最容易被低估**——它是**每一轮都重复发送**的固定开销，而且随工具数量线性增长。下面第六节有 Uber 的实测数字。

## 一、Prompt Caching：这一层最直接的省钱手段
...
5–7 万 token **每轮重复**——在 20 轮的会话里就是 100 万 token 级别。这已经不是「浪费一点」，而是成本结构的主要部分。
