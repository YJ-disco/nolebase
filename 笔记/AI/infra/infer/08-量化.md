...
- **AWQ: Activation-aware Weight Quantization for LLM Compression and Acceleration**（MLSys 2024 最佳论文）：https://arxiv.org/abs/2306.00978
...
- **vLLM — Quantization 支持矩阵与 `compressed-tensors`**：https://docs.vllm.ai/en/latest/features/quantization/
- **llm-compressor（compressed-tensors 的量化工具）**：https://github.com/vllm-project/llm-compressor
- **Marlin: Fast INT4 Kernel**（把反量化与 GEMM 融合）：https://github.com/IST-DASLab/marlin
- **KIVI: A Tuning-Free Asymmetric 2bit Quantization for KV Cache**：https://arxiv.org/abs/2402.02750
- **方法对照、vLLM 格式表与 Marlin 静默回退、五个坑的量化数据**：这三处数字来自第三方技术博客与评测（JarvisLabs 的 Qwen2.5-32B / H200 基准、vLLM 源码走读），**属于二手整理，引用前建议按 vLLM 官方文档复核**：https://thakicloud.com/tech-blog/en/llmops/llm-quantization-vllm-serving-unsloth ｜ https://deepwiki.com/tenstorrent/vllm/3.4-quantization-strategies ｜ https://dineshblog.com/blog/session-dl-067-quantization
